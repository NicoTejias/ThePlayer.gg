...
const mockArticles: MediaArticle[] = [
  { id: '1', title: 'An├ílisis del Metajuego Moderno Post-Baneos', author: 'Admin', excerpt: 'Exploramos c├│mo los ├║ltimos cambios han afectado el panorama competitivo de Modern con la salida de Fury y Grief.', imageUrl: 'https://images.unsplash.com/photo-1613771404784-3a5686aa2be3?auto=format&fit=crop&q=80&w=800', category: 'Modern' },
  { id: '2', title: 'Top 5 Cartas de Commander que Deber├¡as Jugar', author: 'Invitado', excerpt: 'Un ranking de las cartas m├ís impactantes y vers├ítiles para tu pr├│ximo mazo de Commander.', imageUrl: 'https://images.unsplash.com/photo-1635326444826-06c8f84991a9?auto=format&fit=crop&q=80&w=800', category: 'Commander' },
  { id: '3', title: 'Reporte: Ganador del RCQ Santiago', author: 'JuezLocal', excerpt: 'Entrevista exclusiva con el ganador del ├║ltimo Regional Championship Qualifier.', imageUrl: 'https://images.unsplash.com/photo-1511512578047-dfb367046420?auto=format&fit=crop&q=80&w=800', category: 'Reporte' },
  { id: '4', title: 'La Econom├¡a de MTG: ┬┐Momento de Invertir?', author: 'FinanceGuru', excerpt: 'Analizamos las tendencias del mercado secundario y qu├⌐ cartas podr├¡an subir de precio.', imageUrl: 'https://images.unsplash.com/photo-1620325867502-221cfb5faa5f?auto=format&fit=crop&q=80&w=800', category: 'Finanzas' },
  { id: '5', title: 'Gu├¡a de Draft: Lost Caverns of Ixalan', author: 'LimitedPro', excerpt: 'Domina el formato limitado con nuestra gu├¡a de arquetipos y pick orders para el nuevo set.', imageUrl: 'https://images.unsplash.com/photo-1500964757637-c85e8a162699?auto=format&fit=crop&q=80&w=800', category: 'Limited' },
  { id: '6', title: 'Entrevista con el Team campe├│n de Chile', author: 'Redacci├│n', excerpt: 'Conversamos con los miembros del equipo que representar├í al pa├¡s en el mundial.', imageUrl: 'https://images.unsplash.com/photo-1526666923127-b2970f64b422?auto=format&fit=crop&q=80&w=800', category: 'Entrevista' },
];
...
const mockMarketplace: MarketplacePost[] = [
  ...
  { id: '2', title: 'Vendo fetchlands de Modern Horizons 2', type: 'Venta', seller: 'CardTraderCL', region: 'Valpara├¡so', imageUrl: 'https://picsum.photos/seed/market2/400/300' },
  { id: '3', title: 'Cambio Ragavan por Solitude', type: 'Cambio', seller: 'ProPlayer', region: 'Biob├¡o', imageUrl: 'https://picsum.photos/seed/market3/400/300' },
  ...
  { id: '7', title: 'Cambio Orcish Bowmasters', type: 'Cambio', seller: 'Archer101', region: 'Valpara├¡so', imageUrl: 'https://picsum.photos/seed/market7/400/300' },
  ...
  { id: '10', title: 'Vendo Deck Modern Rakdos Scam', type: 'Venta', seller: 'CompPlayer', region: 'Biob├¡o', imageUrl: 'https://picsum.photos/seed/market10/400/300' },
...
const sliderItems = [
  { id: 1, title: '├Ültimas Noticias', link: '/media', imageUrl: 'https://images.unsplash.com/photo-1504711434969-e33886168f5c?auto=format&fit=crop&q=80&w=800', color: 'from-blue-600/80' },
  ...
  { id: 3, title: 'Art├¡culos', link: '/media/articulos', imageUrl: 'https://images.unsplash.com/photo-1585241936939-be05368a5bcb?auto=format&fit=crop&q=80&w=800', color: 'from-green-600/80' },
...
const HomePage: React.FC<HomePageProps> = ({ players, events }) => {
  ...
  const topPwpPlayers = [...players]
    ...
    .slice(0, 10)
    .map((p, i) => {
      // Generar n├║mero an├│nimo consistente basado en hash del ID
      const hashCode = p.id.split('').reduce((acc, char) => {
        return char.charCodeAt(0) + ((acc << 5) - acc);
      }, 0);
      const anonymousNumber = Math.abs(hashCode % 9000) + 1000; // N├║mero de 4 d├¡gitos (1000-9999)
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        {/* Column 1: Pr├│ximos Eventos */}
        <section className="flex flex-col h-full">
          <SectionHeader title="Pr├│ximos Eventos" linkTo="/eventos" />
              ...
              displayEvents.map((event) => (
                ...
                >
                  ...
                  <div className="text-slate-500 text-[10px] flex items-center gap-1">
                    <span>≡ƒôà {event.date}</span>
                  </div>
                </Link>
              ))
            ) : (
              <p className="text-slate-400 text-sm text-center py-10">No hay eventos pr├│ximos.</p>
            )}
      ...
      <section className="mt-24 mb-12 relative px-4">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400 mt-2 font-medium">El ecosistema competitivo m├ís grande de Chile</p>
        </div>
