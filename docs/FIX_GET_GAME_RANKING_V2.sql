-- =============================================================================
-- RECREAR FUNCIÓN get_game_ranking (VERSIÓN FINAL CORREGIDA)
-- =============================================================================

-- 1. ELIMINAR LA FUNCIÓN EXISTENTE
DROP FUNCTION IF EXISTS public.get_game_ranking(TEXT);

-- 2. CREAR LA FUNCIÓN CON CONVERSIÓN DE TIPO CORRECTA
...
BEGIN
    ...
    WHERE t.game_type::TEXT = p_game_type  -- Convertir ENUM a TEXT
    GROUP BY p.id
