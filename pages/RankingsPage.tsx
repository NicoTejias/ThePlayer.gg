    ...
    return (
        <div className="space-y-12 pb-20">
            ...
            <div className="max-w-6xl mx-auto space-y-8">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-6 glass-premium p-4 rounded-[2rem] border border-white/5">
                    {/* Tab Switcher */}
                    ...
                    {activeTab === 'individual' && (
                        <div className="flex flex-col md:flex-row gap-4 w-full lg:w-auto flex-grow justify-end">
                            ...
                            <select
                                ...
                                className="bg-slate-950/50 border border-white/5 rounded-2xl py-4 px-6 text-white font-bold text-sm focus:outline-none focus:ring-2 focus:ring-sky-500/50 min-w-[180px]"
                            >
