...
const mockEvents: CommunityEvent[] = [
  { id: '1', title: 'Clasificatorio Nacional', date: '25 DIC 2024', store: 'Magicsur', format: 'Standard', imageUrl: 'https://picsum.photos/seed/event1/400/300' },
  { id: '2', title: 'Store Championship', date: '28 DIC 2024', store: 'Guildreams', format: 'Modern', imageUrl: 'https://picsum.photos/seed/event2/400/300' },
  { id: '3', title: 'FNM Draft', date: '30 DIC 2024', store: 'Ouroboros', format: 'Draft', imageUrl: 'https://picsum.photos/seed/event3/400/300' },
];

const mockArticles: MediaArticle[] = [
    { id: '1', title: 'Análisis del Metajuego Moderno Post-Baneos', author: 'Admin', excerpt: 'Exploramos cómo los últimos cambios han afectado el panorama competitivo de Modern.', imageUrl: 'https://picsum.photos/seed/article1/400/300' },
    { id: '2', title: 'Top 5 Cartas de Commander que Deberías Jugar', author: 'Invitado', excerpt: 'Un ranking de las cartas más impactantes y versátiles para tu próximo mazo de Commander.', imageUrl: 'https://picsum.photos/seed/article2/400/300' },
];

const mockMarketplace: MarketplacePost[] = [
    {id: '1', title: 'Busco Force of Will', type: 'Compra', seller: 'User123'},
    {id: '2', title: 'Vendo fetchlands de Modern Horizons 2', type: 'Venta', seller: 'CardTraderCL'},
    {id: '3', title: 'Cambio Ragavan por Solitude', type: 'Cambio', seller: 'ProPlayer'},
];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {mockEvents.map((event) => (
            <Card key={event.id} imageUrl={event.imageUrl} title={event.title}>
              <p className="text-slate-400">{event.store}</p>
              <p>{event.date}</p>
              <div className="mt-4">
