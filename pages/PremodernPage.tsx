...
const mockPremodernArticles = [
    { id: '1', title: 'Premodern: El regreso a la era dorada', author: 'Old School Player', excerpt: 'Cartas con marco antiguo, reglas modernas. Un viaje nostálgico al Magic de 1995-2003.', imageUrl: 'https://picsum.photos/seed/premodern1/400/300', category: 'Premodern' },
];

const mockPremodernVideos = [
    { id: '1', title: 'Grand Prix Premodern Final', channel: 'Old School Magic', youtubeId: 'dQw4w9WgXcQ', thumbnailUrl: 'https://picsum.photos/seed/premodern-vid/400/300', category: 'Tournament' },
];

const PremodernPage: React.FC = () => {
    return (
        <div className="space-y-16 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="text-center">
                <h1 className="text-4xl sm:text-5xl font-bold text-white tracking-tighter uppercase">Premodern</h1>
                <p className="text-lg text-slate-300 mt-2 max-w-4xl mx-auto">
                    Un formato comunitario para los amantes de la estética clásica y el gameplay de antaño.
                </p>
            </div>
            ...
            <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {mockPremodernArticles.map(article => (
